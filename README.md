...
> 当前公开版本为 [`0.1.0-beta.1`](https://github.com/0dizzy0/remoPhoto/releases/tag/v0.1.0-beta.1)，已通过 GitHub Releases 发布。当前开发候选为 `0.1.0`（`versionCode = 6`）。7 月 8 日最新 signed APK SHA-256 为 `aa3a392eb1085008be9a16260419b80b18fd3326683eb179f399300d78c56eb1`，已通过一键 Smoke、JVM、Lint、Release 构建、3/3 Android 集成测试、应用内备份导出 Release 日志隐私抽查和 `beta.1 -> 0.1.0` 数据保留验证；正式公开发布前仍需完成 CI、Tag、Release 和线上附件复验。
...
当前 `0.1.0` 候选 APK 的本地基础门禁已通过，候选 SHA-256、剩余发布门禁和风险状态见[项目状态](docs/project/项目状态.md)。
