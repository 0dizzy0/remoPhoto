...
> 当前公开版本为 [`0.1.0-beta.1`](https://github.com/0dizzy0/remoPhoto/releases/tag/v0.1.0-beta.1)，已通过 GitHub Releases 发布。构建、签名、升级、备份、Android 12/16 双机回归、GitHub Actions 和线上附件复验均已通过；该版本仍是测试版本，不应视为稳定版本。
...
当前 `lintDebug` 已达到 `No issues found`，版本号、Room schema、本地 Release 签名、发布安全策略、真机核心回归和最小 CI 均已完成，详见[项目状态](docs/project/项目状态.md)。
